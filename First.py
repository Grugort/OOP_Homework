class Student:
    ...
    def average_grade(self):
        ...
        A = len(Student.grades.values())
        B = list(Student.grades.values())
        C = []
        for i in range(0, A):
            C += B[i]
        average = sum(C) / len(C)
...
class Lecturer(Mentor):
    ...
    def average_grade(self):
        ...
        A = len(Lecturer.grades.values())
        B = list(Lecturer.grades.values())
        C = []
        for i in range(0, A):
            C += B[i]
        average = sum(C) / len(C)
...
def ocenka_lectorov(lecture_list,kurs):
    average_grade=[]
    for i in range (0,leng_lecture):
        if kurs in lecture_list[i]['grades']:
            average_grade += lecture_list[i]['grades'][kurs]
            print (lecture_list[i]['grades'][kurs])
            print(average_grade)
            print(sum(average_grade) / len(average_grade))

def ocenka_studentov(student_list,kurs):
    average_grade=[]
    for i in range (0,leng_student):
        if kurs in student_list[i]['grades']:
            average_grade+=student_list[i]['grades'][kurs]
            print (student_list[i]['grades'][kurs])
            print(average_grade)
            print(sum(average_grade)/len(average_grade))
